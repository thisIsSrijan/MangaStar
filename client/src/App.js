      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/shonen"
            element={
              <ShopCategory banner={shonen_banner} category={"Shonen"} />
            }
          />
          <Route
            path="/romcom"
            element={
              <ShopCategory banner={romcom_banner} category={"RomCom"} />
            }
          />
          <Route
            path="/shojo"
            element={<ShopCategory banner={shojo_banner} category={"Shojo"} />}
          />
